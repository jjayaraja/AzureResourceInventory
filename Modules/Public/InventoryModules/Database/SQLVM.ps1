...
.Link
https://github.com/jjayaraja/AzureResourceInventory/Modules/Public/InventoryModules/Database/SQLVM.ps1
...
Else {
    ...
    if ($SmaResources) {
        ...
        $TableName = ('SQLVMTable_'+($SmaResources.'Resource U').count)
