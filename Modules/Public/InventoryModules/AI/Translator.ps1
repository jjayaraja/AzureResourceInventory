...
.Link
https://github.com/jjayaraja/AzureResourceInventory/Modules/Public/InventoryModules/AI/Translator.ps1
...
Else
{
    ...
    if($SmaResources)
    {
        ...
        $TableName = ('TranslaTable_'+($SmaResources.'Resource U').count)
